# -*- coding: utf-8 -*-
"""
Created on Mon Jun 17 12:51:46 2019
...
# def EN_TL_model(input_shape,n_out_classes):
...
# #     x = Dropout(0.3)(x)
#     final_output = tf.keras.layers.Dense(n_out_classes, activation='softmax', name='final_output')(x)
